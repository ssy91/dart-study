import '../../5일차/book-quiz2-2선생님답.dart';

void main() {
  // const = 변수의 값을 수정할 수 없는 변수형
  // const 는 compile-time 에 알고 있어야 한다.
  // compile-time 이 무엇이냐?
  // run debugging 을 해서 main 함수를 실행하게 되면
  // 컴퓨터는 맨 위의 코드부터 한 줄 한줄 컴파일 이라는 것을 진행해서
  ...
  // 값을 가지고 있지 않게 됩니다.
  // 그렇긴 때문에 const 로 선언된 변수는 함수는 기본값으로 설정을 할 수 없게 되는 것입니다.
  const hello = sayHello();

  // 값을 변경할 수 없는 변수에 함수를 담고 싶다면 const 가 아닌 final 을 이용해야 한다.
